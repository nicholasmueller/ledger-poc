...
export const availability = Observable.create(observer => {
...
export const connectDevice = device => new Promise((resolve, reject) => {
...
export const disconnectDevice = device => new Promise((resolve, reject) => {
...
export const isDeviceDisconnected = device => device.state === "disconnected";
...
export const listen = () => Observable.create(observer => {
...
export const write = (writeCharacteristic, buffer) => new Promise((resolve, reject) => {
